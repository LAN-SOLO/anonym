  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• Ablauf: bearbeitete Datei wählen → Recover-Datei wählen (anonym schlägt die passende daneben vor) → ggf. Passwort → Ziel wählen (Vorschlag <name>.recovered.<endung>). Das Ergebnis zeigt, wie viele Stellen zurückübersetzt wurden und wie viele Ersatzwerte nicht mehr vorkamen.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• Flow: choose the edited file → choose the recover file (anonym suggests the matching one next to it) → password if needed → choose the target (suggestion <name>.recovered.<ext>). The result shows how many places were translated back and how many substitutes no longer occurred.',

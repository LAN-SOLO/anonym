  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• Zahlen in Excel-Zellen, Bilder, eingebettete Objekte und Metadaten (Autor im Dokument) werden nicht geprüft.',
    ...
    },
    {
      id: 'shortcuts',
      title: 'Tastatur',
      body: ['• O — Datei öffnen', '• S — Anonymisiert speichern', '• 1, 2, 3, 4 — Reiter Fundstellen, Vorschau, Regelwerk, Bericht', '• ? — Handbuch', '• ⌘/Strg + , — Einstellungen', '• Esc — Dialog schließen'],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '• Numbers in Excel cells, images, embedded objects and metadata (document author) are not checked.',
    ...
    },
    {
      id: 'shortcuts',
      title: 'Keyboard',
      body: ['• O — open file', '• S — save anonymised', '• 1, 2, 3, 4 — tabs Findings, Preview, Rules, Report', '• ? — manual', '• ⌘/Ctrl + , — settings', '• Esc — close dialog'],
    },
  ],
};
